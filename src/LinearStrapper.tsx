...
import { ImageForm } from "./ImageFrom";
import Reg from "./Reg";
...
function getSteps() {
    ...
    //     "Basic information",
    //     "Contact information",
    //     "Personal Information || ChooseFile",
    //     "Payment",
    // ];
    return[
        "",
            ...
            <Controller
                ...
                render={({ field }) => (
                    <TextField
                        ...
                        label="old age"
                        variant="outlined"
                        placeholder="Enter Your old age"
                        fullWidth
                        margin="normal"
                        {...field}
                    />
...
const LinaerStepper = () => {
    ...
    const [skippedSteps, setSkippedSteps] =React.useState<any>([]);
